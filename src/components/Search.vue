<template>
<div class="">
    <div class="relative md:w-1/2 md:m-auto ">
        <span class="absolute flex items-center w-10 mx-1 mt-3 ">
    ...
    <input type="text" class="w-full md:w-1/2 static shadow rounded py-3 px-8 " v-model="filterData" placeholder="Search" @input="search(filterData)">
</div>
</template>
